          ...
          child: SafeArea(
            child: Column(
              children: flag
                  ...
                  InkWell(
                    onTap: () {
                      Modal_Country mc1 = Modal_Country(
                          countryname: country[e.key],
                          flag: flag[e.key], president : president[e.key], info1 : info[e.key]);

                      // Modal_Country mc1 = Modal_Country(
                      //     countryname : country[e.key],
                      //     flag1 : flag[e.key],
                      //     president1 : president[e.key],
                      //     info1 : info[e.key]);

                      Navigator.pushNamed(context, "UI", arguments: mc1);
                    },
